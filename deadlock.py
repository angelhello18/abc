...
'''
Conclusion:
This code implements the Chandy-Misra-Haas algorithm to detect deadlocks in a system of processes. It uses probe messages to trace dependencies, and if a probe returns to the initiator, a deadlock is confirmed. The output successfully shows one scenario with a deadlock and another without, proving the algorithm's effectiveness.
'''
